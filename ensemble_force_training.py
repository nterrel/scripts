...
batched_dataset_path = Path('/home/nick/batched_dataset_1x')
...
print('Self atomic energies: ', self_energies)
...
for _ in range(AdamW_scheduler.last_epoch + 1, max_epochs):
    ...
    for i, properties in tqdm.tqdm(
        ...
        _, predicted_energies = [model((species, coordinates)) for model in models]
